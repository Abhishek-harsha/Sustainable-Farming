...
import { FiHome, FiActivity, FiCpu, FiAward, FiTarget, FiUsers, FiSettings, FiBarChart2 } from 'react-icons/fi';
...
export default function Sidebar() {
    ...
    const farmerLinks = [
        ...
        { to: '/assessment', icon: FiBarChart2, label: 'Sustainability Assessment' },
    ];
